...
for q in range(5):
    ...
    ET.SubElement(name, "text").text = "truefalse "+str(q+1)+': '+fake.catch_phrase() # Question name 
...
ET.indent(tree)
tree.write("truefalsesnum.xml",xml_declaration=True, encoding="utf-8",short_empty_elements=True) # Enabled self-closed tag