...
ET.SubElement(name, "text").text = fake.sentence() # Question name 
...
ET.SubElement(truefeedback,"text").text = fake.catch_phrase() + ' (true)!'
...
ET.SubElement(falsefeedback,"text").text = fake.catch_phrase() + ' (false)!'
    
tree = ET.ElementTree(quiz)
ET.indent(tree)
tree.write("truefalse.xml",xml_declaration=True, encoding="utf-8",short_empty_elements=True) # Enabled self-closed tag